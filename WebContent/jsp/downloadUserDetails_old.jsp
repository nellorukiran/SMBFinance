...
<div class="regOutDiv">
	<div class="download-out">
		...
		<div class="download-order-outdiv" style="display:none;">
			<div class="download-order-id11"><a style="font-family: arial;font-size: 20px;font-weight: bold;text-decoration: none;color:blue;" href="userDownloadDeatilsCusId">ORDER BY CUSTOMER ID</a></div>
			<div class="download-order-address"><a style="font-family: arial;font-size: 20px;font-weight: bold;text-decoration: none;color:blue;" href="userDownloadDeatilsAddress">ORDER BY ADDRESS</a></div>
		</div>
