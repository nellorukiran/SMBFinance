...
public class CustomerRegistrationBizlogic {
	...
	public static String customerCreation(HttpServletRequest request) {
		int cus_id = 0, buy_price = 0, advance = 0, tot_price = 0, tot_dues = 0, saled_price = 0, profit = 0,
				bal_amt = 0, penalty = 0;
	...
	public static String customerCreationSave(HttpServletRequest request) {
		...
		String cus_name = "", address = "", item_name = "", due_time = "", buy_date = "", shop_name = "",
				model_name = "", phone = "";
		float doc_amt = 0f, next_due_amt = 0f, due_amt = 0f, profit = 0f, tot_price = 0f, bal_amt = 0f,
				per_due_amt = 0f, intrest_amt = 0f, tot_profit = 0f;
	...
	public static String viewAdminUsers(HttpServletRequest request) {
		...
		try {
			...
			if (userDetailsRs.isBeforeFirst()) {
				if (userDetailsRs != null)
					request.setAttribute("resultset", userDetailsRs);
