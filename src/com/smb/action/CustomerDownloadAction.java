...
public class CustomerDownloadAction extends ActionSupport implements ServletRequestAware{
	...
	public String userDownloadDeatils(){
		...
		System.out.println("userDownloadDeatils inputVal-->"+inputVal);
		String inputType = request.getParameter("inputType");
		inputType = (inputType != null)? inputType:"";
		System.out.println("userDownloadDeatils inputType-->"+inputType);
		...
		if(inputVal.length() > 0){
			...
			if(!"downloaded".equals(customerData)){
				...
				System.out.println("userDownloadDeatils ::"+successMsg);
				//isCusData = "ERROR";
			}else{
				successMsg ="<div style=\"float:left;\"><b><font color='green' size='2'> Downloaded Successfully Order By.</font><font color='red' size='2'>"+inputVal+"</font></b></div>";				
				//addActionError(successMsg);
				System.out.println("userDownloadDeatils ::"+successMsg);
				//isCusData = "SUCCESS";
			}*/
	...
	public String userDownloadProfitDeatils(){
		...
		if(fromDate.length()>0 && toDate.length()>0){
			String customerData = CustomerDownloadBizlogic.userDownloadProfitDeatils(fromDate,toDate,folderName,inputVal,request);
			if(!"downloaded".equals(customerData)){
				successMsg ="<div style=\"float:left;\"><b><font color='red' size='2'>Not Downloade Successfully.</font></div>";	
				addActionError(successMsg);			
				isCusData = "profiltDetails";
			}else{
				successMsg ="<div style=\"float:left;\"><b><font color='green' size='2'> Downloaded Successfully Order By.</font><font color='red' size='2'>"+inputVal+"</font></b><br><b><font color='red' size='2'> File Location :</font><font color='blue'>"+CommonUtil.getFileLocation(inputVal, folderName)+"</font></b><br><b><font color='red' size='2'> File Name : </font><font color='blue'>"+CommonUtil.getFileName(inputVal, folderName)+"</font></b></div>";				
				addActionError(successMsg);				
				isCusData = "profiltDetails";
			}
		}
